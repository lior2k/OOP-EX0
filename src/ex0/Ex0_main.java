...
public class Ex0_main {
    public static Long ID0=206284960L, ID1 =315021923L, ID2 = null;
    public static void main(String[] ar) {
        ...
        //MyElevatorAlgo2 ex0_alg = new MyElevatorAlgo2((Simulator_A.getBuilding()));
        MyElevatorAlgo ex0_alg = new MyElevatorAlgo((Simulator_A.getBuilding()));
